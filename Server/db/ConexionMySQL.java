...
public class ConexionMySQL {
    ...
    public ConexionMySQL(){
        urlDB = "jdbc:mysql://cc2.cluster-c6v4bv6mx5lv.us-east-1.rds.amazonaws.com:3306/";
        nameDB = "Mail";
        userDB = "admin";
        passwordDB = "xKhWfdWSHEeSm8WXAUqZ";
...
//            }
    ...
    /**
     * Devuelve un ResultSet de una consulta realizada
     * @param q
     * @return
     * @throws SQLException
     */
    public ResultSet executeQuerySting(String q) throws SQLException {
        ////cnx = openConnection();
        ...
        try{
            ...
            String error_msg = "Se produjo un error al crear la declaracion, asegurese de que se haya establecido la conexion a la base de datos.";
            System.out.println(error_msg);
        }
        try{
            rs = stm.executeQuery(q);
        }catch(Exception e){
            String error_msg = "Hubo un error al procesar la consulta, informacion adicional a continuacion:\n"+e.getMessage();
            System.out.println(error_msg);
        }
        //closeConnection();
        return rs;
